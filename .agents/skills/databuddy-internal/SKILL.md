...
- Jev candidate selection uses the pinned Gateway evaluation SDK; keep all retained preferences until native portfolio grouping/limits. Validate the complete answer map, probability bounds and declared rounding before using probabilities to exclude work.
