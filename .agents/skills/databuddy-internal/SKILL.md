...
- Keep Jev model initialization in its owning classifier; do not add a provider-wrapper file for a single initializer. Slack message types already live in `ai/mcp/slack-context.ts`.
