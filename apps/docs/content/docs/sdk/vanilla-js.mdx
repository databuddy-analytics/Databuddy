...
<Callout type="info">
  **CDN**: `https://cdn.databuddy.cc/databuddy.js` | **Current size**: about 39 KB minified / 12 KB gzip
</Callout>
...
The script is automatically minified and served compressed. The current bundle is about 39 KB minified and 12 KB gzip; check release notes for future size changes.
