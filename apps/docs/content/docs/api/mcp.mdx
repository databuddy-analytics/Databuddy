...
| `read:links` | Read short links, folders, and link search results |
| `read:data` + `write:links` | Update or delete short links for an accessible website |
| `read:data` + `read:links` + `write:links` | Create short links |
