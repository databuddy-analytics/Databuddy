...
| `MISSING_WEBSITE_ID` | 400 | The custom-query endpoint needs `website_id` | Add `website_id` to the query string |
...
| `QUERY_ERROR` | 400 | The custom query could not be executed | Check the message and query definition |
