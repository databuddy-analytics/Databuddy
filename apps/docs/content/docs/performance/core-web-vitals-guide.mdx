...
The Databuddy tracker is about 13 KB gzipped and loads asynchronously. Measure its impact alongside your other scripts; no analytics script has a universal zero-cost guarantee.
