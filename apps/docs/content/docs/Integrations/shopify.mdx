...
Review your Shopify privacy and consent configuration before enabling collection. Databuddy uses browser storage instead of analytics cookies; optional customer identification and order properties may contain personal data. See the [web analytics privacy guide](/docs/compliance/gdpr-compliance-guide).
