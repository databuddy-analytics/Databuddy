...
Add Databuddy's privacy-first analytics to your WordPress site with an asynchronous tracker that is about 12 KB gzipped. No cookies, fully GDPR compliant.
...
Track submissions from popular WordPress form plugins with a small submit handler:
