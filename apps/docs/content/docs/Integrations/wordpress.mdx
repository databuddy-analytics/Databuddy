...
Add Databuddy's privacy-first analytics to your WordPress site with an asynchronous tracker that is about 12 KB gzipped. The tracker uses browser storage instead of analytics cookies. Review your [privacy and consent configuration](/docs/compliance/gdpr-compliance-guide) before enabling collection.
...
- **Lightweight**: About 12 KB gzipped for the current tracker bundle
