...
Track visits, custom events, errors, and performance on your Framer site. Databuddy uses browser storage instead of analytics cookies; review your [privacy and consent configuration](/docs/compliance/gdpr-compliance-guide) before enabling collection.
