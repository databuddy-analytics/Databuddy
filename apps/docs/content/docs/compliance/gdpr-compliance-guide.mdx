...
- No cookies required
- Anonymous tracking in the default configuration
...
For anonymous default tracking there is usually no personal data to act on. If you identify users, requests about those profiles apply in full: contact [privacy@databuddy.cc](mailto:privacy@databuddy.cc) and see our [Data Policy](/data-policy) for how data flows through the system.
