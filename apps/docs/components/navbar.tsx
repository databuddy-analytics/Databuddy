									...
									<NavigationMenuList className="gap-1">
										{navMenu.map((menu) => (
											<NavigationMenuItem key={menu.name}>
												<Link
													href={menu.path}
													className="inline-flex h-9 w-max items-center justify-center rounded-md bg-transparent px-4 py-2 text-sm font-medium hover:bg-accent/80 hover:text-accent-foreground focus:bg-accent focus:text-accent-foreground disabled:pointer-events-none disabled:opacity-50 transition-all duration-200 ease-out hover:scale-105 hover:shadow-sm"
												>
													{menu.name}
												</Link>
											</NavigationMenuItem>
