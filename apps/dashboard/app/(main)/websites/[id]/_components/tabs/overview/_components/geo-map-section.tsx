...
export function GeoMapSection({ countries, isLoading }: GeoMapSectionProps) {
 ...
 if (isLoading) {
 return (
 <div className="w-full overflow-hidden border bg-accent/50 backdrop-blur-sm">
 ...
 Geographic distribution
			...
			<div
				...
				style={{ minHeight: 350 }}
			>
				<div className="relative flex-1 max-lg:aspect-video lg:min-h-0 [&>div]: [&>div]:border-0">
					<MapComponent
						height="100%"
						isLoading={false}
 ...
 <div className="absolute right-2 bottom-2 z-1 w-44 shrink-0 border border-t bg-muted">
 <div className="h-9 border-b bg-muted px-2">
 ...
 <div className="max-h-48 overflow-y-auto bg-background lg:max-h-none">
