				...
				<ContextMenu>
					...
					<ContextMenuTrigger asChild>
						<div className="block h-full rounded outline-none focus-visible:outline-none">
							...
							>
								<Card className="flex h-full select-none flex-col gap-0 overflow-visible bg-background p-0 transition-all duration-300 ease-in-out group-hover:border-primary/60 motion-reduce:transform-none motion-reduce:transition-none">
