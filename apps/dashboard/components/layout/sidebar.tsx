...
export function Sidebar({ user = null }: SidebarProps) {
  ...
  return (
    <>
      {/* Mobile Header */}
      <header className="fixed top-0 right-0 left-0 z-40 h-12 w-full border-b border-border bg-background md:hidden">
      ...
      <nav
        ...
        className={cn(
          "fixed inset-y-0 z-50 w-80 overflow-hidden bg-background",
          "border-r border-border transition-transform duration-200 ease-out",
          "left-0 md:left-16",
          "pt-12 md:pt-0",
          "md:translate-x-0",
