...
export function NavigationItem({
  ...
  if (isLocked) {
    return (
      <div
        aria-disabled
        className="group flex h-12 min-w-0 cursor-not-allowed items-center gap-3 px-3 text-sidebar-foreground/40 text-sm"
  ...
  if (disabled) {
    return (
      <div
        aria-disabled
        className="group flex h-12 min-w-0 cursor-not-allowed items-center gap-3 px-3 text-sidebar-foreground/30 text-sm"
      >
        {content}
        {tag && (
  ...
  return (
    <LinkComponent
      ...
      className={cn(
        "group flex h-12 min-w-0 items-center gap-3 border-transparent border-r-2 px-3 text-sm hover:text-sidebar-accent-foreground",
        isActive
