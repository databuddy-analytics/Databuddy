				...
				<div className="flex items-center gap-2">
					{showFullScreen && onFullScreenToggle && (
						<button
							...
							className="flex size-8 items-center justify-center rounded border-sidebar-border bg-sidebar-accent/30 text-sidebar-foreground transition-colors hover:bg-accent-brighter"
