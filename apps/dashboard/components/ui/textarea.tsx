		...
		return (
			<div className={cn('relative flex-1 min-w-0', wrapperClassName)}>
				<TextareaAutosize
					ref={ref}
					className={cn(
						'field-sizing-content flex min-h-16 w-full border border-accent-brighter px-3 py-2 text-sm outline-none transition-all placeholder:text-muted-foreground disabled:cursor-not-allowed disabled:opacity-50',
				...
				{showFocusIndicator && (
					<motion.span
						className={cn(
							'absolute bottom-0 left-1 right-1 h-[2px] pointer-events-none',
