...
const DefaultLoader = () => (
 ...
 <span className="size-1.5 bg-muted-foreground/60 animate-pulse" />
 <span className="size-1.5 bg-muted-foreground/60 animate-pulse [animation-delay:150ms]" />
 <span className="size-1.5 bg-muted-foreground/60 animate-pulse [animation-delay:300ms]" />
 </div>
 </div>
);
...
function DefaultMarkerIcon() {
 return (
 <div className="relative h-4 w-4 border-2 border-white bg-blue-500 shadow-lg" />
 );
}
...
function MarkerPopup({
 ...
 <div
 className={cn(
"relative border bg-popover p-3 text-popover-foreground shadow-md animate-in fade-in-0 zoom-in-95",
 className
 )}
 >
 {closeButton && (
 ...
 type="button"
 onClick={handleClose}
 className="absolute top-1 right-1 z-10 opacity-70 ring-offset-background transition-opacity hover:opacity-100 focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2"
...
function MarkerTooltip({
 ...
 <div
 className={cn(
" bg-foreground px-2 py-1 text-xs text-background shadow-md animate-in fade-in-0 zoom-in-95",
 className
 )}
 >
 {children}
...
function ControlGroup({ children }: { children: React.ReactNode }) {
 return (
 <div className="flex flex-col border border-border bg-background shadow-sm overflow-hidden [&>button:not(:last-child)]:border-b [&>button:not(:last-child)]:border-border">
 {children}
 </div>
 );
}
