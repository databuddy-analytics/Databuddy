	...
	return (
		<DayPicker
			...
			classNames={{
				...
				today: cn(
					'rounded border-2 border-ring bg-accent text-accent-foreground shadow-xs transition-[color,box-shadow] data-[selected=true]:rounded-none',
