...
test("business source pages are bounded public URLs scoped to the selected site", () => {
	...
	for (const url of ["file:///secret", "http://127.0.0.1/", "http://[::1]/", "http://localhost/", "https://app.internal/", "https://user:secret@example.com/", "https://example.com:444/", "https://example.com/?token=secret", "https://example.com/#secret"]) {
