...
[AGPL-3.0](LICENSE), except packages with a separate license, including the [MIT-licensed scanner](packages/scan/LICENSE). Copyright (c) 2025 Databuddy Analytics, Inc.
